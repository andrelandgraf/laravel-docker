...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__HttpService_js__ = __webpack_require__(50);
...
var PizzaService = function () {
    ...
    _createClass(PizzaService, null, [{
        key: 'baseUrl',
        value: function baseUrl() {
            return __WEBPACK_IMPORTED_MODULE_0__HttpService_js__["a" /* default */].apiUrl() + '/pizza/';
        }
        ...
        key: 'addNewPizza',
        value: function addNewPizza(pizza) {
            return new Promise(function (resolve, reject) {
                __WEBPACK_IMPORTED_MODULE_0__HttpService_js__["a" /* default */].post('' + PizzaService.baseUrl(), pizza, function (data) {
                    return resolve(data);
                }, function (textStatus) {
...
/* harmony default export */ __webpack_exports__["a"] = (PizzaService);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_js__ = __webpack_require__(51);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var HttpService = function () {
    ...
    _createClass(HttpService, null, [{
        ...
        value: function apiUrl() {
            return __WEBPACK_IMPORTED_MODULE_0__config_js__["a" /* appUrl */] + ":" + __WEBPACK_IMPORTED_MODULE_0__config_js__["b" /* port */];
        }
        ...
        key: "delete",
        value: function _delete(url, onSuccess, onError) {
            var header = new Headers();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return appUrl; });
// Configuration variables from .env
var port = Object({"MIX_PUSHER_APP_KEY":"","MIX_PUSHER_APP_CLUSTER":"mt1","NODE_ENV":"development"}).PORT || '8080';
var appUrl = Object({"MIX_PUSHER_APP_KEY":"","MIX_PUSHER_APP_CLUSTER":"mt1","NODE_ENV":"development"}).APP_URL || 'http://localhost';
